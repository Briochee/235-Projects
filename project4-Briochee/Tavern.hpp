...
class Tavern : public ArrayBag<Character*>{
  public:
    //new parameterized constructor to store pointer to characters rather than objects
    /**
...
*/
    ...
    **/
    bool enterTavern(Character* const& a_character);
    ...
    **/
    bool exitTavern(Character* const& a_character);
    ...
    */
    ...
    //@post: for every character in the tavern, displays each characters information
