...
class Tavern : public ArrayBag<Character*>{
    public:
        ...
        */
        void setMainCharacter(Character* const& character);
        ...
        */
        bool levelIsLess(const Character* character1, const Character* character2) const;

        /* levelIsGreater()
        @param: two Character pointers
        @return: true if the lhs Character's level is greater than the rhs Character's level
        */
        bool levelIsGreater(const Character* character1, const Character* character2) const;

        /* vitalityIsLess
        @param: two Character pointers
        @return: true if the lhs Character's vitality is less than the rhs Character's vitality
        */
        bool vitalityIsLess(const Character* character1, const Character* character2) const;

        /* vitalityIsGreater()
        @param: two Character pointers
        @return: true if the lhs Character's vitality is more than the rhs Character's vitality
        */
        bool vitalityIsGreater(const Character* character1, const Character* character2) const;
        ...
        */
        ...
        //void actionSelection(const int& input1, const int& input2, const int& input3);
        ...
        */
        void combat();
        //void combat(const int& input1, const int& input2, const int& input3);

       std::queue<Character*> battleQueue(){return combat_queue_;}
    ...
    private:
        ...
        */
        ...
        //print action details helper function
        void printActionResults(const int& action, const bool& friendly);
        void applyAction(Character* character, const int& action, const bool& friendly);
};
#endif
