...
struct Buff{
    ...
    //keeps track if buff has been applied
    bool applied_ = false;
    //my implementation
    Buff(const std::string& name = "", const int& turns = 0, const bool& applied = false) : name_(name), turns_(turns), applied_(applied){}  //parameterized constructor
};
